"""
Django settings for ProyectoGrupal project.
...
SECRET_KEY = '^e52wj31hx$dx!ow76romx+jq-3%_cwpuw8i2r%4^=$dlqx#@k'
...
ROOT_URLCONF = 'ProyectoGrupal.urls'
...
WSGI_APPLICATION = 'ProyectoGrupal.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'rtv', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
